            ...
            <div class="row">
                ...
                <div class="col-2 col-sm-4 col-md-3 col-lg-4 text-right">
                    ...
                    <ul class="customer-links list-inline">
                      @if (Auth::check())
                      <li><a href="{{ route('profile12.index') }}">{{ Auth::user()->name }}</a></li>
    	...
    	<div class="container-fluid">        
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="index.html">
                    	<img src="assets/images/logo.svg" alt="BOOK STORE" title="BOOK STORE" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                	...
                	<nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                        ...
                        <li class="lvl1 parent dropdown"><a href="/about">About us <i class="anm anm-angle-down-l"></i></a>
                            ...
                            <li><a href="/about" class="site-nav">About Us 
                            </a>
                        </li>
